...
const TARGETS: UploadTarget[] = [
  {
    key: "about-mission-desktop",
    filePath: path.join(
      ASSET_ROOT,
      "WEBSITE",
      "ABOUT US PAGE",
      "DESKSTOP",
      "Our Mission section image- 5th section (Desktop version)",
      "Our mission.png",
    ),
    title: "About Mission Desktop",
    alt: "Our Mission — Building The Future Of Non-Surgical Hair Solutions (desktop)",
    description: "About Us page Our Mission section image (desktop) with baked-in quote text.",
  },
  {
    key: "about-mission-mobile",
    filePath: path.join(
      ASSET_ROOT,
      "WEBSITE",
      "ABOUT US PAGE",
      "MOBILE",
      "Our Mission section image- 4th section (Mobile version)",
      "Our mission.png",
    ),
    title: "About Mission Mobile",
    alt: "Our Mission — Building The Future Of Non-Surgical Hair Solutions (mobile)",
    description: "About Us page Our Mission section image (mobile) with baked-in quote text.",
  },
];
...
main().catch((error) => {
  console.error("About mission upload failed:", error);
  process.exit(1);
});
