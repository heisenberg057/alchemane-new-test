    ...
    return [
      {
        ...
        title: `SMP Result ${n} Desktop`,
        alt: `Scalp Micro Pigmentation real result transformation ${n} (desktop)`,
        description: `SMP page Real Results section — transformation ${n} desktop image.`,
      },
      {
        key: `smp-result-${n}-mobile`,
        filePath: path.join(
          ASSET_ROOT,
          "WEBSITE",
          "SMP PAGE DESKTOP V1",
        ...
        title: `SMP Result ${n} Mobile`,
        alt: `Scalp Micro Pigmentation real result transformation ${n} (mobile)`,
        description: `SMP page Real Results section — transformation ${n} mobile image.`,
      },
    ];
  }).flat();
...
main().catch((err) => {
  console.error("SMP results upload failed:", err);
  process.exit(1);
});
