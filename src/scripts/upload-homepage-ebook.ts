...
const TARGETS: UploadTarget[] = [
  {
    ...
    filePath: path.join(
      ...
      "HOMEPAGE",
      "DESKTOP",
      "Free eBook section images - Homepage 2nd last section",
      "ebook ..png",
    ),
    title: "Homepage Ebook Default Desktop",
    alt: "The Ultimate Guide to Choosing the Perfect Hair System ebook cover",
    description: "Desktop ebook cover used by the shared ebook section.",
  },
  {
    key: "mobile",
    filePath: path.join(
    ...
    title: "Homepage Ebook Default Mobile",
    alt: "The Ultimate Guide to Choosing the Perfect Hair System ebook cover",
    description: "Mobile ebook cover used by the shared ebook section.",
  },
];
...
main().catch((error) => {
  console.error("Homepage ebook upload failed:", error);
  process.exit(1);
});
