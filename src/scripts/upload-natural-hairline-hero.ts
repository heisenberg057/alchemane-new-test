...
const TARGETS: UploadTarget[] = [
  {
    ...
    filePath: path.join(
      ...
      "DESKTOP",
      "Will My Hairline Look Real Hero section image",
      "NATURAL HAIRLINE 16x9.png",
    ),
    title: "Natural Hairline Hero Desktop",
    alt: "Natural-looking hairline before and after transformation.",
    description: "Desktop hero image for the will my hairline look real page.",
  },
  {
    key: "mobile",
    filePath: path.join(
      ...
      "MOBILE",
      "Will My Hairline Look Real Hero section image",
      "NATURAL HAIRLINE 4X5.png",
    ),
    title: "Natural Hairline Hero Mobile",
    alt: "Natural-looking hairline before and after transformation.",
    description: "Mobile hero image for the will my hairline look real page.",
  },
];
...
main().catch((error) => {
  console.error("Natural hairline hero upload failed:", error);
  process.exit(1);
});
