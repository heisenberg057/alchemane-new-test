...
const TARGETS: UploadTarget[] = [
  {
    key: "about-hero-desktop",
    filePath: path.join(
      ASSET_ROOT,
      "WEBSITE",
      "ABOUT US PAGE",
      "DESKSTOP",
      "Meet Our Expert Team Hero section image - 1st section ( Desktop version)",
      "Meet our expert team.png",
    ),
    title: "About Hero Desktop",
    alt: "American Hairline expert team — Meet Our Expert Team",
    description: "About Us page hero image (desktop) — expert team composite with baked-in text.",
  },
  {
    key: "about-hero-mobile",
    filePath: path.join(
      ASSET_ROOT,
      "WEBSITE",
      "ABOUT US PAGE",
      "MOBILE",
      "Meet Our Expert Team Hero section image - 1st section",
      "Meet our expert team.png",
    ),
    title: "About Hero Mobile",
    alt: "American Hairline expert team — Meet Our Expert Team",
    description: "About Us page hero image (mobile) — expert team composite with baked-in text.",
  },
];
...
main().catch((error) => {
  console.error("About hero upload failed:", error);
  process.exit(1);
});
