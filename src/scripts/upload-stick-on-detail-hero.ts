...
const TARGETS: UploadTarget[] = [
  {
    ...
    filePath: path.join(
      ...
      "DESKTOP",
      "Stick-On Hair System Hero section image",
      "STICK ON.png",
    ),
    title: "Stick On Hair System Detail Hero Desktop",
    alt: "Stick-on hair system before and after transformation showing a secure natural-looking hairline.",
    description: "Desktop hero image for the stick-on hair system detail page.",
  },
  {
    key: "mobile",
    filePath: path.join(
    ...
    title: "Stick On Hair System Detail Hero Mobile",
    alt: "Mobile stick-on hair system before and after transformation showing a secure natural-looking hairline.",
    description: "Mobile hero image for the stick-on hair system detail page.",
  },
];
...
main().catch((error) => {
  console.error("Stick-on detail hero upload failed:", error);
  process.exit(1);
});
