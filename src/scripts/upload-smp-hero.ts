...
const TARGETS: UploadTarget[] = [
  {
    key: "smp-hero-desktop",
    filePath: path.join(
      ASSET_ROOT,
      "WEBSITE",
      "SMP PAGE DESKTOP V1",
      "DESKTOP",
      "SCALP MICRO PIGMENTATION Hero section image - 1st section",
      "image 1.png",
    ),
    title: "SMP Hero Desktop",
    alt: "Scalp Micro Pigmentation procedure result — natural-looking hairline (desktop)",
    description: "SMP page hero section image (desktop) with baked-in text.",
  },
  {
    key: "smp-hero-mobile",
    filePath: path.join(
    ...
    title: "SMP Hero Mobile",
    alt: "Scalp Micro Pigmentation procedure result — natural-looking hairline (mobile)",
    description: "SMP page hero section image (mobile) with baked-in text.",
  },
];
...
main().catch((error) => {
  console.error("SMP hero upload failed:", error);
  process.exit(1);
});
