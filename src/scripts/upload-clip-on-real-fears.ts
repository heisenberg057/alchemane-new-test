...
const TARGETS: UploadTarget[] = [
  {
    key: "clip-on-real-fears-desktop",
    filePath: path.join(
      ASSET_ROOT,
      "WEBSITE",
      "DETAILS CLIP ON PAGE",
      "DESKTOP",
      "The Real Fears Men Have section image",
      "The Real Fears Men Have section image.png",
    ),
    title: "Clip-On Real Fears Desktop",
    alt: "Man contemplating hair loss — The Real Fears Men Have section (desktop)",
    description: "Clip-on page — The Real Fears Men Have section image (desktop, 1600×1200, 4/3).",
  },
  {
    key: "clip-on-real-fears-mobile",
    filePath: path.join(
      ASSET_ROOT,
      "WEBSITE",
      "DETAILS CLIP ON PAGE",
    ...
    title: "Clip-On Real Fears Mobile",
    alt: "Man contemplating hair loss — The Real Fears Men Have section (mobile)",
    description: "Clip-on page — The Real Fears Men Have section image (mobile, 1670×1025, 145/89).",
  },
];
...
main().catch((error) => {
  console.error("Clip-on real fears upload failed:", error);
  process.exit(1);
});
