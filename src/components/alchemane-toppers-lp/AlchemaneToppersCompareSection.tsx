...
import { TOPPERS_COMPARE } from './content';
import styles from './AlchemaneToppersCompareSection.module.css';
import { AlchemaneCtaButton } from '@/components/alchemane/AlchemaneCtaButton';

export function AlchemaneToppersCompareSection() {
  const { titlePrefix, titleEmphasis, otherHead, usHead, captionOther, ctaLabel, rows } = TOPPERS_COMPARE;
