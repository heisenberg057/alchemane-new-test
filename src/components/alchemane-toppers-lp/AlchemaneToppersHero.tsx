...
import { TOPPERS_HERO } from './content';
import styles from './AlchemaneToppersHero.module.css';

export function AlchemaneToppersHero({
  mediaBase,
  heroCtaRef,
}: {
  mediaBase: string;
  ...
  const { badge, title, ctaLabel, ctaNote, video, trustTitle, trustBreak, trustItems } = TOPPERS_HERO;
