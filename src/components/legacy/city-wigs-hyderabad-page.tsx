...
const whyHairLossBullets = [
  { bold: 'Genetics & Hereditary Factors:', text: ' The most common cause of hair loss in men is hereditary androgenetic alopecia. If your father or grandfather experienced baldness, you are more likely to as well.' },
  { bold: 'The Quality Of Water:', text: " Hyderabad's hard water contains high mineral content that can weaken hair follicles over time, leading to increased breakage and thinning." },
  { bold: 'The Conditions In Hyderabad:', text: " Stress, pollution, and lifestyle factors unique to Hyderabad's urban environment can accelerate hair loss significantly in men of all ages." },
  { bold: 'Nutritional Deficiencies:', text: ' A diet lacking in iron, zinc, biotin, or vitamin D can contribute to noticeable hair thinning and loss. Addressing these deficiencies is an important step.' },
];

const humanHairBullets = [
  { bold: 'Premium Natural Hair:', text: ' Our hair wigs for men in Hyderabad are made from 100% human hair, ensuring they look, feel, and move exactly like your natural hair.' },
  { bold: 'Replacement Consideration:', text: ' Our expert team guides you through every stage of the replacement process — from consultation to fitting — ensuring the most comfortable and natural outcome.' },
  { bold: 'The Quality Is Incomparable:', text: ' We source only the finest hair and base materials, resulting in systems that look premium and last significantly longer than standard alternatives.' },
  { bold: 'Styles Made Manageable:', text: ' Our wigs can be cut, styled, and coloured just like natural hair, giving you complete freedom to achieve any hairstyle you desire.' },
  { bold: 'Customer Complaints Addressed:', text: ' We take customer feedback seriously and have an active support team dedicated to resolving any concerns quickly and to your complete satisfaction.' },
];

const fullWigsBullets = [
  { bold: 'For Hair Wigs:', text: ' Our full wigs provide seamless, natural-looking coverage for men in Hyderabad experiencing any level of hair loss — from minor thinning to complete baldness.' },
  { bold: 'For Hair Patches:', text: ' Targeted patches cover specific areas of hair loss without affecting the surrounding natural hair, providing precise and undetectable coverage.' },
  { bold: 'Affordable & Versatile:', text: ' Our range of full wigs suits a variety of budgets without compromising on the quality, naturalness, or durability of the system.' },
];

const methodsBullets = [
  { bold: 'Glue + Wigs:', text: " Medical-grade adhesive bonds the wig securely to the scalp. This method provides a long-lasting hold ideal for Hyderabad's active lifestyle." },
  { bold: 'Adhesive Strips:', text: ' Double-sided strips applied around the perimeter offer a clean, comfortable bond — easy to apply and suitable for everyday wear.' },
  { bold: 'Tape-On Application:', text: ' Medical-grade tape provides a strong, comfortable hold that is gentle on the scalp and can be replaced easily during maintenance sessions.' },
];

const suggestionsAccordion = [
  { title: 'Free Consultation with Our Experts', desc: 'Begin with a free consultation at our Hyderabad studio. Our specialists will assess your hair loss, scalp health, and lifestyle needs to recommend the ideal wig solution for you.' },
  { title: 'Review Customisation Options', desc: 'Explore our full range of customisation options — from base material to hair density to hairline shape. A custom system always delivers a more natural and long-lasting result.' },
  { title: 'Commitment to Our Own Solutions', desc: 'Every product and method we recommend is one we have personally tested and verified. We only suggest solutions we trust completely and that have delivered proven results.' },
  { title: 'Background On My Services', desc: 'American Hairline has served thousands of clients across Hyderabad and India. Our background in premium non-surgical hair replacement means every client receives expert-level care.' },
];

const faqs = [
  { q: 'Find the best wigs for Men in Hyderabad?', a: "American Hairline is one of Hyderabad's leading providers of premium human hair wigs for men. We offer fully customised systems, professional fitting, and comprehensive aftercare support." },
  { q: "Is it convenient to use wigs in Hyderabad's climate?", a: "Yes. Our wigs are made with breathable, moisture-resistant base materials specifically suited for Hyderabad's warm climate. Our recommended adhesives maintain a strong bond all day." },
  { q: 'Are wigs suitable in Hyderabad for daily use?', a: 'Absolutely. Our systems are designed for 24/7 wear. With the right adhesive and regular maintenance, you can wear your wig continuously and simply refresh the bond every 3–4 weeks.' },
  { q: 'What happens to the wig if it starts looking less natural?', a: 'Schedule a maintenance visit with our Hyderabad team. We will re-adhesive, clean, and restyle your system so it looks completely natural again. Consistent servicing prevents this issue.' },
  { q: 'Is styling equipment appropriate to use on the wig?', a: 'Yes. Our 100% human hair wigs can be styled with straighteners, curlers, and blow dryers just like natural hair. Always use a heat protectant to preserve the quality and longevity of the system.' },
];
      ...
      <div className="w-full max-w-[1440px] px-4 md:px-10 xl:px-[160px]">
        <div ref={ref} className="text-center mb-[48px] md:mb-[64px]">
          <h1 className={`text-[32px] md:text-[52px] font-extrabold text-[#121212] leading-[1.1] tracking-[-1.5px] mb-[20px] ${inView ? 'anim-fade-up' : 'opacity-0'}`}>
            Hair Wigs For Men<br />In Hyderabad
          </h1>
          <p className={`text-[16px] font-[500] text-[#555555] leading-[1.7] max-w-[600px] mx-auto ${inView ? 'anim-fade-up delay-200' : 'opacity-0'}`}>
            Looking for the best hair wigs for men in Hyderabad? Our premium human hair wigs are specially designed for men in Hyderabad. We offer the best quality hair wigs that look and feel completely natural, helping you regain your confidence.
          </p>
        </div>
        <div className={`relative w-full rounded-[20px] md:rounded-[24px] overflow-hidden bg-[#0a0c10] h-[280px] md:h-[500px] shadow-[0px_24px_64px_0px_rgba(0,0,0,0.2)] ${inView ? 'anim-scale-in delay-300' : 'opacity-0'}`}>
          <Image src="https://pub-dfcfdec07a8f40f2b756b4cce22c7bf9.r2.dev/media/legacy-results-story-sameer-after.png" alt="Hair Wigs In Hyderabad" fill className="object-cover object-top" sizes="(max-width: 768px) 100vw, 720px" />
          ...
          <div className="absolute bottom-[24px] md:bottom-[40px] left-[24px] md:left-[48px]">
            ...
            <p className="text-white/55 text-[13px] md:text-[18px] font-bold tracking-[0.2em] uppercase mt-[4px] m-0">IN HYDERABAD</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="bg-[#F5F6F7] py-[72px] md:py-[120px] flex justify-center w-full">
      <div className="w-full max-w-[1440px] px-4 md:px-10 xl:px-[160px]">
        <h2 className="text-[26px] md:text-[44px] font-extrabold text-[#121212] leading-[1.2] tracking-[-0.5px] text-center mb-[48px] md:mb-[64px]">
          Why Hair Loss Occurs Among Men<br />In Hyderabad City?
        </h2>
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-[48px] md:gap-[64px] items-stretch">
          <div className={`w-full flex md:items-stretch justify-center ${inView ? 'anim-slide-r' : 'opacity-0'}`}>
            <div className="relative w-full h-[280px] md:h-auto rounded-[16px] overflow-hidden bg-[#0a0c10] shadow-[0px_4px_24px_rgba(18,18,18,0.08)] flex-1">
              <Image src="https://pub-dfcfdec07a8f40f2b756b4cce22c7bf9.r2.dev/media/legacy-smp-step-2.png" alt="Why Hair Loss Hyderabad" fill className="object-cover object-center" style={{ opacity: 0.5 }} />
...
function HumanHairSection() {
  ...
  return (
    <section className="bg-white py-[72px] md:py-[120px] flex justify-center w-full">
      <div className="w-full max-w-[1440px] px-4 md:px-10 xl:px-[160px]">
        <h2 className="text-[26px] md:text-[44px] font-extrabold text-[#121212] leading-[1.2] tracking-[-0.5px] text-center mb-[48px] md:mb-[64px]">
          Men's Human Hair Wigs<br />In Hyderabad
        </h2>
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-[48px] md:gap-[64px] items-stretch">
          ...
          <div className={`w-full flex md:items-stretch justify-center ${inView ? 'anim-slide-l delay-200' : 'opacity-0'}`}>
            <div className="relative w-full h-[280px] md:h-auto rounded-[16px] overflow-hidden bg-[#0a0c10] shadow-[0px_4px_24px_rgba(18,18,18,0.08)] flex-1">
              <Image src="https://pub-dfcfdec07a8f40f2b756b4cce22c7bf9.r2.dev/media/legacy-smp-step-1.png" alt="Human Hair Wigs Hyderabad" fill className="object-cover object-center" style={{ opacity: 0.5 }} />
              <div className="absolute inset-0 bg-gradient-to-t from-[rgba(5,7,10,0.88)] via-[rgba(5,7,10,0.5)] to-[rgba(5,7,10,0.2)]" />
              <div className="absolute top-[20px] md:top-[28px] left-[20px] md:left-[28px]">
                <p className="text-white text-[16px] md:text-[22px] font-extrabold leading-[1.2] m-0">
                  <span className="text-white/60">HY SHAVE?</span>{' '}<span className="text-white">TRY</span>{' '}<span style={{ color: '#4686FE' }}>CLIP-ON</span>
        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-[48px] md:gap-[64px] items-stretch">
          <div className={`w-full flex md:items-stretch justify-center ${inView ? 'anim-slide-r' : 'opacity-0'}`}>
            <div className="relative w-full h-[280px] md:h-auto rounded-[16px] overflow-hidden bg-[#121212] shadow-[0px_4px_24px_rgba(18,18,18,0.08)] flex-1">
              <Image src="https://pub-dfcfdec07a8f40f2b756b4cce22c7bf9.r2.dev/media/legacy-smp-step-3.png" alt="Full Hair Wigs Hyderabad" fill className="object-cover object-center" />
    ...
    <section className="bg-[#F5F6F7] py-[72px] md:py-[120px] flex justify-center w-full">
      <div className="w-full max-w-[1440px] px-4 md:px-10 xl:px-[160px]">
        <h2 className="text-[26px] md:text-[44px] font-extrabold text-[#121212] leading-[1.2] tracking-[-0.5px] text-center mb-[48px] md:mb-[56px]">
          Our Suggestions For Choosing The<br />Right Wig In Hyderabad
        </h2>
        ...
        <div ref={contentRef} className={`max-w-[760px] mx-auto ${contentInView ? 'anim-fade-up' : 'opacity-0'}`}>
          <p style={{ ...cardBodyStyle, color: '#555555', marginBottom: '32px' }}>
            Selecting the right wig in Hyderabad requires careful consideration. Our specialists are here to guide you through every step. Here are our top suggestions to help you make the best choice for your lifestyle and preferences.
          </p>
            ...
            {suggestionsAccordion.map((item, i) => (
              <div key={i} className="bg-white rounded-[12px] overflow-hidden cursor-pointer" style={{ border: '1px solid rgba(18,18,18,0.08)', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }} onClick={() => setOpenIndex(openIndex === i ? -1 : i)}>
                <div className="flex justify-between items-center px-[20px] md:px-[24px] py-[16px] md:py-[18px]">
                  ...
                  <span style={{ fontSize: '20px', fontWeight: 700, color: 'rgba(18,18,18,0.4)', flexShrink: 0, userSelect: 'none', lineHeight: 1 }}>{openIndex === i ? '×' : '+'}</span>
                </div>
                {openIndex === i && (
    ...
    <section className="bg-white py-[72px] md:py-[120px] flex justify-center w-full">
      <div className="w-full max-w-[1440px] px-4 md:px-10 xl:px-[160px]">
        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-[48px] md:gap-[64px] items-stretch">
          <div className={`${inView ? 'anim-slide-r' : 'opacity-0'}`}>
            <div className="rounded-[16px] overflow-hidden h-full flex flex-col justify-center bg-white shadow-[0px_4px_24px_rgba(18,18,18,0.08)]">
              <div className="p-[24px] md:p-[32px] flex flex-col gap-[20px]">
                ...
                <p style={cardBodyStyle}>
                  Regular servicing every 3–4 weeks is key to extending the life of your system. Our Hyderabad team provides a complete care kit, video tutorials, and professional maintenance support to keep your wig looking its absolute best between sessions.
                </p>
              </div>
            </div>
          </div>
          <div className={`w-full flex md:items-stretch justify-center ${inView ? 'anim-slide-l delay-200' : 'opacity-0'}`}>
            <div className="relative w-full h-[280px] md:h-auto rounded-[16px] overflow-hidden bg-[#121212] shadow-[0px_4px_24px_rgba(18,18,18,0.08)] flex-1">
              <Image src="https://pub-dfcfdec07a8f40f2b756b4cce22c7bf9.r2.dev/media/legacy-smp-step-2.png" alt="Life of Hair Wig Hyderabad" fill className="object-cover object-center" />
...
export default function HyderabadWigsPage() {
  return (
    <main>
      <HeroSection />
      <WhyHairLossSection />
