...
import {
  BANGALORE_OFFER_CHECKS,
  BANGALORE_OFFER_GUIDANCE,
} from './content';
import styles from './BangaloreOfferSection.module.css';
...
function GuaranteeBadge() {
  return (
    <svg
      ...
      viewBox="0 0 220 220"
      role="img"
      aria-labelledby="bangalore-guarantee-badge-title"
    >
      <title id="bangalore-guarantee-badge-title">
        100 percent consultation-fee satisfaction guarantee
      </title>
      <defs>
        <linearGradient id="bangalore-guarantee-badge-gradient" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#4686fe" />
          <stop offset="1" stopColor="#1769ff" />
        </linearGradient>
        <path
          id="bangalore-guarantee-badge-ring"
          d="M110,110 m-79,0 a79,79 0 1,1 158,0 a79,79 0 1,1 -158,0"
        />
      </defs>
      <circle cx="110" cy="110" r="102" fill="url(#bangalore-guarantee-badge-gradient)" />
      <circle
        cx="110"
        cy="110"
        r="88"
      ...
      <text className={styles.badgeRing}>
        <textPath href="#bangalore-guarantee-badge-ring" startOffset="50%" textAnchor="middle">
...
export function BangaloreOfferSection() {
  ...
  return (
    <section
      ...
      aria-labelledby="bangalore-consultation-title"
    >
      <div className={styles.card}>
        <h2 id="bangalore-consultation-title" className={styles.title}>
          Let’s Start with a
          <br />
        ...
        <div className={styles.guarantee}>
          ...
          <div>
            ...
            <p className={styles.guaranteeCopy}>
              ...
              If you don’t find it <strong>genuine or valuable, we’ll refund the consultation fee
              in full</strong>{' '}
              — no questions asked.
            </p>
          </div>
        ...
        <div className={styles.guidance}>
          ...
          <ul className={styles.bullets}>
            {BANGALORE_OFFER_GUIDANCE.map((parts, bulletIndex) => (
        ...
        <div className={styles.checks}>
          {BANGALORE_OFFER_CHECKS.map((item) => (
