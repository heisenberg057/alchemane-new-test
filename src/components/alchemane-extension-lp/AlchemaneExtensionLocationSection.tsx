...
import { EXTENSION_LOCATION_PHOTOS } from './content';
import styles from './AlchemaneExtensionLocationSection.module.css';

export function AlchemaneExtensionLocationSection({ mediaBase }: { mediaBase: string }) {
  const count = EXTENSION_LOCATION_PHOTOS.length;
        ...
        <div className={styles.carousel} role="group" aria-roledescription="carousel" aria-label="Studio photos">
          ...
          <div className="carouselNav">
            ...
            <div className="carouselProgress" aria-label="Select studio photo">
              {EXTENSION_LOCATION_PHOTOS.map((_, index) => (
